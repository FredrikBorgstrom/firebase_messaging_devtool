...
Run `dart pub publish --dry-run` or `cd firebase_messaging_devtool && dart pub publish --dry-run` first to check for any analysis errors or warnings. Fix any issues reported.
